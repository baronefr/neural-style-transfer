...
\end{minipage}
\hfill\vline\hfill
\begin{minipage}[t][\textheight]{0.8\textwidth}
    {\raggedleft
        {\prependtitle\par}
    ...
    \vspace{1cm}
\end{minipage}
\begin{textblock*}{0.01cm}(1.7cm,3cm)
\begin{turn}{90}
...
\textbf{\LaTeX\space template Copyright} \copyright 2022--\the\year\ Francesco Barone (\href{https://github.com/baronefr}{git@baronefr}). This attribution shall not be removed even if the template is used in other documents.\par
\copyrightmention
...
Document compiled: \today. \textbf{Version \docuver}.
\vspace{.7cm}
